#ifndef SINECO_TRANSFORM_H
#define SINECO_TRANSFORM_H
...
class SINECO_Transformation : public QWidget
{
    Q_OBJECT

public:
    explicit SINECO_Transformation(QWidget *parent = 0);
    ~SINECO_Transformation();
...
private:
    ...
    void ApplySINECO_Transformation(PointCloudT::Ptr input, PointCloudT::Ptr output,  Eigen::Matrix4f SINECO_TransformationMatrix);
};

#endif // SINECO_ TRANSFORM_H
