#include "SINECO_Ponte.h"
#include "ui_SINECO_Ponte.h"

SINECO_Ponte::SINECO_Ponte(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::SINECO_Ponte)
{
    ui->setupUi(this);
...
void SINECO_Ponte::on_pushButton_compute_LUM_clicked()
{
...
void SINECO_Ponte::on_pushButton_compute_ELCH_clicked()
{
